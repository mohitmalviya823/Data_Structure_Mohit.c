...
void deleteFromPositionMyDoublyList() {
    ...
    position = temp->next;                  // Mohit Malviya        
...
void insertAtBeginingMyCircularList(int element) {
    struct cnode *newP = malloc(sizeof(struct cnode));
    newP->data = element;
    newP->next = tail->next;                      // Mohit Malviya        
    tail->next = newP;
    printf("Element inserted successfully!\n");
}
...
void enqueueMyListQueue() {
    ...
    newP->data = element;                                      // Mohit Malviya        
    newP->link = NULL;
...
void insertMyArrayBST() {
    ...
    if(bst[rootArray] == 0) {                                            // Mohit Malviya
...
void MyListBST() {
    ...
    do{
        ...
        switch(choice) {                                                        
            ...
            case 6:
                printf("Exited successfully!\n");
                // printf("Developed By: Mohit Malviya")
                break;
            default:
                printf("Invalid choice!\n");
                break;
